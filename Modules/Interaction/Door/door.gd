...
## Generic Door class
##
## ALl doors extend this generic door

## Emitted when door [member is_disabled] is changed
signal disabled(value: bool)

## Pass in that locker that locks this door
@export var locker: Lockable = null

## Flag if door is open
